package com.example.imagechoosedemo.adapters;
...
import com.example.imagechoosedemo.R;
import com.example.imagechoosedemo.utils.ImageUtils;
import com.example.imagechoosedemo.utils.ImgCallBack;
...
public class ImageAdapter extends BaseAdapter {
	...
	public ImageAdapter(Context context,List<String> data,OnItemClickClass onItemClickClass) {
		this.context=context;
		this.data=data;
		this.onItemClickClass=onItemClickClass;
		bitmaps=new Bitmap[data.size()];
		util=new ImageUtils(context);
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg0 != index && arg0 > index) {
			index=arg0;
			arg1=LayoutInflater.from(context).inflate(R.layout.image_item, null);
			holder=new Holder();
